...
PERMISSIONS = {
    ...
    "production.assign_vendor": {ROLE_ADMIN, ROLE_PRODUKSI},
    "production.set_deadline": {ROLE_ADMIN, ROLE_PRODUKSI},
    "production.update_status": {ROLE_ADMIN, ROLE_PRODUKSI},
    "production.update_qc": {ROLE_ADMIN, ROLE_PRODUKSI},
    "production.update_checking": {ROLE_ADMIN, ROLE_PRODUKSI},
    "production.finish": {ROLE_ADMIN, ROLE_PRODUKSI},
